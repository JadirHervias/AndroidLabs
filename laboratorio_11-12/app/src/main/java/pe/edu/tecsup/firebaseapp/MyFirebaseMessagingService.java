    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            if (remoteMessage.getNotification() != null) {
                ...
                // Icon
                int iconId = (icon == null) ? R.mipmap.ic_launcher_round : this.getResources().getIdentifier(icon,
                ...
                Uri soundUri = (sound == null || "default".equals(sound)) ?
                        ...
                        Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + this.getPackageName() + "/raw/" +
                                sound);
